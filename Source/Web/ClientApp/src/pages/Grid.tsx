...
const Grid = () => {
	...
	const colDefs: ColDef<EntryDto>[] = [
		...
		{ field: "tiebreaker", headerName: "Tb", headerTooltip: "Predicted Total Score", suppressMovable: true, width: 80 },
		{ field: "score", headerName: "Score", headerTooltip: "Number of Correct Picks", suppressMovable: true, width: 90 },
		{
